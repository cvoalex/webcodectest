...
type InferBatchRequest struct {
	...
	VisualFrames  []byte                 `protobuf:"bytes,2,opt,name=visual_frames,json=visualFrames,proto3" json:"visual_frames,omitempty"`
	AudioFeatures []byte                 `protobuf:"bytes,3,opt,name=audio_features,json=audioFeatures,proto3" json:"audio_features,omitempty"`
...
type InferBatchResponse struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Outputs         []*RawMouthRegion      `protobuf:"bytes,1,rep,name=outputs,proto3" json:"outputs,omitempty"`
	...
	GpuId           int32                  `protobuf:"varint,6,opt,name=gpu_id,json=gpuId,proto3" json:"gpu_id,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *UnloadModelResponse) Reset() {
	*x = UnloadModelResponse{}
	mi := &file_proto_inference_inference_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnloadModelResponse) Descriptor() ([]byte, []int) {
	return file_proto_inference_inference_proto_rawDescGZIP(), []int{8}
}
...
func (x *GetModelStatsRequest) Reset() {
	*x = GetModelStatsRequest{}
	mi := &file_proto_inference_inference_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetModelStatsRequest) Descriptor() ([]byte, []int) {
	return file_proto_inference_inference_proto_rawDescGZIP(), []int{9}
}
...
func (x *GetModelStatsResponse) Reset() {
	*x = GetModelStatsResponse{}
	mi := &file_proto_inference_inference_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetModelStatsResponse) Descriptor() ([]byte, []int) {
	return file_proto_inference_inference_proto_rawDescGZIP(), []int{10}
}
...
func (x *HealthRequest) Reset() {
	*x = HealthRequest{}
	mi := &file_proto_inference_inference_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HealthRequest) Descriptor() ([]byte, []int) {
	return file_proto_inference_inference_proto_rawDescGZIP(), []int{11}
}
...
func (x *HealthResponse) Reset() {
	*x = HealthResponse{}
	mi := &file_proto_inference_inference_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HealthResponse) Descriptor() ([]byte, []int) {
	return file_proto_inference_inference_proto_rawDescGZIP(), []int{12}
}
...
func (x *GPUInfo) Reset() {
	*x = GPUInfo{}
	mi := &file_proto_inference_inference_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GPUInfo) Descriptor() ([]byte, []int) {
	return file_proto_inference_inference_proto_rawDescGZIP(), []int{13}
}
...
func (x *ModelInfo) Reset() {
	*x = ModelInfo{}
	mi := &file_proto_inference_inference_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ModelInfo) Descriptor() ([]byte, []int) {
	return file_proto_inference_inference_proto_rawDescGZIP(), []int{14}
}
...
func (x *ModelStats) Reset() {
	*x = ModelStats{}
	mi := &file_proto_inference_inference_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ModelStats) Descriptor() ([]byte, []int) {
	return file_proto_inference_inference_proto_rawDescGZIP(), []int{15}
}
...
const file_proto_inference_inference_proto_rawDesc = "" +
	"\n" +
	"\x1fproto_inference/inference.proto\x12\tinference\"\x99\x01\n" +
	"\x11InferBatchRequest\x12\x19\n" +
	"\bmodel_id\x18\x01 \x01(\tR\amodelId\x12#\n" +
	"\rvisual_frames\x18\x02 \x01(\fR\fvisualFrames\x12%\n" +
	"\x0eaudio_features\x18\x03 \x01(\fR\raudioFeatures\x12\x1d\n" +
	"\n" +
	"batch_size\x18\x04 \x01(\x05R\tbatchSize\"\xd9\x01\n" +
	"\x12InferBatchResponse\x123\n" +
	"\aoutputs\x18\x01 \x03(\v2\x19.inference.RawMouthRegionR\aoutputs\x12*\n" +
	"\x11inference_time_ms\x18\x02 \x01(\x02R\x0finferenceTimeMs\x12\x18\n" +
	"\asuccess\x18\x03 \x01(\bR\asuccess\x12\x14\n" +
	"\x05error\x18\x04 \x01(\tR\x05error\x12\x1b\n" +
	"\tworker_id\x18\x05 \x01(\x05R\bworkerId\x12\x15\n" +
	"\x06gpu_id\x18\x06 \x01(\x05R\x05gpuId\"$\n" +
	...
	"\x0eloaded_unix_ms\x18\x05 \x01(\x03R\floadedUnixMs2\xd0\x03\n" +
	...
	"\tLoadModel\x12\x1b.inference.LoadModelRequest\x1a\x1c.inference.LoadModelResponse\x12K\n" +
	"\vUnloadModel\x12\x1d.inference.UnloadModelRequest\x1a\x1d.inference.UnloadModelRequest\x12R\n" +
	"\rGetModelStats\x12\x1f.inference.GetModelStatsRequest\x1a .inference.GetModelStatsResponse\x12=\n" +
	"\x06Health\x12\x18.inference.HealthRequest\x1a\x19.inference.HealthResponseB'Z%go-compositing-server/proto_inferenceb\x06proto3"
...
var file_proto_inference_inference_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
...
var file_proto_inference_inference_proto_depIdxs = []int32{
	...
	7,  // 15: inference.InferenceService.UnloadModel:output_type -> inference.UnloadModelRequest
