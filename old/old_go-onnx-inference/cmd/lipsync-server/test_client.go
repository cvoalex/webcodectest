...
func main() {
	...
	for _, batchSize := range testBatchSizes {
		...
		// For simplicity, use the first audio window (in real app, client selects appropriate window)
		...
		fmt.Printf("      Server inference time: %.2fms\n", response.InferenceTimeMs)
